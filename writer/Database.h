...
public:
    ...
    virtual void create_table(const std::vector<std::string>&, const std::string&) const = 0;
    [[nodiscard]] virtual std::vector<std::string> retrieve_cols(rapidcsv::Document&, const std::string&) const = 0;
    virtual void write_rows(const rapidcsv::Document&, const std::vector<std::string>&, const std::string&) const = 0;
